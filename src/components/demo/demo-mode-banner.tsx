...
export function DemoModeBanner() {
  ...
  return (
    <>
      {/* A fix pozíciós vezérlősáv ne takarja el az oldal utolsó tartalmi blokkját. */}
      <div aria-hidden="true" className="h-28 shrink-0 sm:h-20" />
      <div
        role="region"
      ...
      >
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-5 py-3.5 sm:flex-row sm:items-center sm:gap-6 sm:px-8">
          ...
          <div className="hidden shrink-0 items-center gap-1.5 sm:flex" aria-label="Bemutató lépések">
            {DEMO_STEPS.map((s, i) => (
              <button
                key={s.title}
                type="button"
